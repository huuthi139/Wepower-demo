  ...
  return (
    <div className="group bg-black rounded-xl overflow-hidden border border-white/10 hover:border-red hover:shadow-card-hover transition-all duration-300">
      <Link href={`/courses/${course.id}`}>
        ...
        <div className="p-5">
          {/* Category */}
          <div className="text-xs text-yellow font-bold mb-2 uppercase">
            {course.category}
          </div>

          {/* Title */}
          <h3 className="text-lg font-bold text-white mb-2 line-clamp-2 group-hover:text-red transition-colors">
            {course.title}
          </h3>

          {/* Instructor */}
          <p className="text-sm text-white/60 mb-3">{course.instructor}</p>
