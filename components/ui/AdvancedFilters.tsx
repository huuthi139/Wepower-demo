  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-white/[0.03] border border-white/[0.06] rounded-xl text-white hover:border-teal transition-colors"
      >
      ...
      {/* Filters Panel */}
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-80 bg-dark border border-white/[0.06] rounded-xl p-6 shadow-card z-50 animate-slideDown">
          {/* Price Range */}
          <div className="mb-6">
            ...
            <div className="space-y-3">
              <div className="flex gap-3">
                <div className="flex-1">
                  <input
                    ...
                    className="w-full px-3 py-2 bg-white/[0.03] border border-white/[0.06] rounded-lg text-white text-sm focus:outline-none focus:border-teal"
                    placeholder="Từ"
                  />
                </div>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 px-2 py-1 bg-white/[0.03] hover:bg-teal/20 rounded text-xs text-white transition-colors"
                >
                  &lt; 1M
                </button>
                <button
