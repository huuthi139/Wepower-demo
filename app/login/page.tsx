        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-black border-2 border-white/10 rounded-xl p-8 hover:border-red/30 transition-all">
            ...
            <form className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 bg-white/5 border-2 border-white/10 rounded accent-red"
                  />
                  <span className="text-white/70 text-sm">Ghi nhớ đăng nhập</span>
                </label>
                <Link href="/forgot-password" className="text-red text-sm hover:underline">
                  Quên mật khẩu?
                </Link>
              </div>
            ...
            <p className="text-center text-white/60 text-sm mt-6">
              Chưa có tài khoản?{' '}
              <Link href="/register" className="text-red hover:underline font-medium">
                Đăng ký ngay
              </Link>
            </p>
          </div>
